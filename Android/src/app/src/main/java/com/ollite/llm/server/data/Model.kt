...
data class Model(
   ...
   * - `com.ollite.llm.server` for builds from the GitHub source.
   * - `com.ollite.llm.server` for other builds (Play store, internal, etc).
   *
   ...
   *
   * /storage/emulated/0/Android/data/com.ollite.llm.server/files/my_model/local_dir/
   *
