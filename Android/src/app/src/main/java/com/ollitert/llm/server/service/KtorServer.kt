...
class KtorServer(
  ...
  internal suspend fun requireAuth(call: ApplicationCall): Boolean =
    com.ollitert.llm.server.service.requireAuth(call, serviceContext)

  internal suspend fun requireServerControl(call: ApplicationCall): Boolean =
    com.ollitert.llm.server.service.requireServerControl(call, serviceContext)
  ...
  internal fun finalizeLogEntry(
    ...
    com.ollitert.llm.server.service.finalizeLogEntry(
      logId = logId,
      startMs = startMs,
      response = response,
  ...
  internal suspend fun withGetLogging(
    ...
    com.ollitert.llm.server.service.withGetLogging(
      call = call,
  ...
  internal suspend fun withRequestLogging(
    ...
    com.ollitert.llm.server.service.withRequestLogging(
      call = call,
      serviceContext = serviceContext,
      defaultModel = defaultModel,
      keepAliveUnloadedModelName = keepAliveUnloadedModelName,
